    ...
    <>
            ...
            >
              <div className="relative aspect-[4/5] w-full overflow-hidden">
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 flex translate-y-3 items-end justify-between px-4 pb-4 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
                  <span className="text-[10px] uppercase tracking-[0.3em] text-charcoal/80">
                    Pl. {String(i + 1).padStart(2, "0")}
                  </span>
                  <span className="border-b border-charcoal pb-0.5 text-[11px] uppercase tracking-[0.3em] text-charcoal">
                    View &rarr;
                  </span>
                </div>
              ...
              <div className="mt-2 flex items-center justify-between text-[10px] uppercase tracking-[0.3em] sm:text-[11px]">
                ...
                <span className="text-charcoal/60 transition-colors duration-200 group-hover:text-gold">
                  View
                </span>
              </div>
            </button>
      ...
      {total > thumbnails.length && (
        <div className="mt-8 flex justify-center sm:mt-10">
          <button
            type="button"
            onClick={() => setIndex(0)}
            className="group inline-flex items-center gap-3 border border-charcoal bg-transparent px-8 py-4 text-[12px] uppercase tracking-[0.3em] text-charcoal transition-colors duration-300 hover:bg-charcoal hover:text-cream"
          >
      ...
      <Dialog open={isOpen} onOpenChange={(o) => !o && closeLightbox()}>
        <DialogContent
          ...
          className="flex h-[92vh] max-h-none w-full max-w-[calc(100%-1rem)] flex-col gap-0 overflow-hidden rounded-none bg-cream p-0 text-charcoal ring-1 ring-charcoal/10 sm:max-w-6xl"
        >
          <DialogTitle className="sr-only">
            Gallery — {developmentName}
          </DialogTitle>

          <div className="flex items-center justify-between border-b border-charcoal/20 px-5 py-4 sm:px-8">
            <span className="text-[11px] uppercase tracking-[0.3em] text-gold-dark">
              {developmentName} &nbsp;&mdash;&nbsp; Gallery
            </span>
            <div className="flex items-center gap-6">
              <span className="font-mono text-[12px] tabular-nums text-charcoal/70">
              ...
              <DialogClose
                render={
                  <button
                    ...
                    className="text-[12px] uppercase tracking-[0.3em] text-charcoal/80 underline decoration-1 underline-offset-4 hover:text-gold"
                  />
                }
              >
                Close
          ...
          <div className="relative flex-1 overflow-hidden bg-cream">
            ...
            <button
              ...
              className="absolute top-1/2 left-3 flex h-14 w-14 -translate-y-1/2 items-center justify-center text-charcoal/70 transition-colors hover:text-gold sm:left-5"
            >
            ...
            <button
              ...
              className="absolute top-1/2 right-3 flex h-14 w-14 -translate-y-1/2 items-center justify-center text-charcoal/70 transition-colors hover:text-gold sm:right-5"
            >
              <span className="text-2xl font-light">&rarr;</span>
            </button>
          </div>

          <div className="border-t border-charcoal/20 bg-cream px-3 py-3 sm:px-6 sm:py-4">
