  ...
  return (
    <>
      ...
      <main className="bg-charcoal text-cream font-sans">
        ...
        {/* Hero */}
        <section className="border-b border-cream/15 pt-16 sm:pt-20">
          <div className="mx-auto flex max-w-[1400px] flex-col items-center px-5 py-16 text-center sm:px-8 sm:py-24">
            <Image
            ...
            />
            <p className="mt-8 max-w-xl text-[13px] uppercase tracking-[0.3em] text-cream/70 sm:text-[14px]">
              Premium new homes, built in small numbers since 2005.
              <br className="hidden sm:inline" /> Surrey &middot; Hampshire
              &middot; South&nbsp;West&nbsp;London.
            </p>
          </div>
        </section>
